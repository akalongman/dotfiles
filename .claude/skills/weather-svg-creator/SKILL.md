...
description: Creates an SVG weather card showing the current temperature for Tbilisi. Writes the SVG to orchestration-workflow/weather.svg and updates orchestration-workflow/output.md.
---

# Weather SVG Creator Skill

Creates a visual SVG weather card for Tbilisi, Georgia and writes the output files.
